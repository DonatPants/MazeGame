...
public class Game extends Canvas implements Runnable{
	...
	//public static final int WIDTH = 720, HEIGHT = 480, TILES_WIDE = 60, TILES_HIGH = 40, PLAYER_WIDTH = 6, PLAYER_HEIGHT = 6; // small maze
	//public static final int WIDTH = 200, HEIGHT = 200, TILES_WIDE = 10, TILES_HIGH = 10, PLAYER_WIDTH = 5, PLAYER_HEIGHT = 5; // tiny maze
	...
	public Game() {
		...
		//if (this.path != null)
		//	System.out.println("we found a way");
	...
	private void tick() {
		/*
		if (count % 10 == 0 && !this.path.isEmpty()) { // does update the player location, but does not update the graphics, this.render() doesn't help
	...
	public void newMaze() {
		...
		//this.player = new Player(this.maze.getStart().getI() * (Game.WIDTH/Game.TILES_WIDE), this.maze.getStart().getJ() * (Game.HEIGHT/Game.TILES_HIGH), ID.Player, PLAYER_WIDTH, PLAYER_HEIGHT, handler, this.maze.getMap(), this);
